...
"")
        ...
        self.verticalLayout_graph.addWidget(self.label_6)

        self.pushButton_start = QPushButton(self.page_home)
...
"}")
        ...
        self.verticalLayout_graph.addWidget(self.pushButton_start)

        self.horizontalLayout_14 = QHBoxLayout()
        self.horizontalLayout_14.setObjectName(u"horizontalLayout_14")
        self.label_status = QLabel(self.page_home)
...
"}")
        ...
        self.horizontalLayout_14.addWidget(self.label_status2)
...
"}")
        ...
        self.horizontalLayout_14.addWidget(self.label_status3)


        self.verticalLayout_graph.addLayout(self.horizontalLayout_14)


        self.verticalLayout_10.addLayout(self.verticalLayout_graph)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"UI Bot Test Pane", None))
